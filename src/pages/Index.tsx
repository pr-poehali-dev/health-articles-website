      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-600 mb-10 max-w-3xl mx-auto">
            ...
            упражнения для сохранения когнитивных навыков, простейшие тесты и
            советы на уровень эмоционального интеллекта. А дальше сайт будет
            наполняться планами питания, статьями по приобретению здоровых
            привычек,психологическими аспектами сопротивления им и прочими
            полезностями, обзоры товаров для упрощения жизни, развитие
            эмоционального интеллекта и нейрофитнес для взрослых и комплексного
